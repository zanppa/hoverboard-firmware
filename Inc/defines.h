...
#define RIGHT_HALL_PORT      GPIOB
#define RIGHT_HALL_LSB_PIN   5
#define RIGHT_HALL_U_PIN GPIO_PIN_5
#define RIGHT_HALL_V_PIN GPIO_PIN_6
#define RIGHT_HALL_W_PIN GPIO_PIN_7

#define LEFT_HALL_PORT     GPIOC
#define LEFT_HALL_LSB_PIN  10
...
#define RIGHT_A_ADC_CH	ADC_CHANNEL_0
#define RIGHT_B_ADC_CH	ADC_CHANNEL_13
#define LEFT_B_ADC_CH	ADC_CHANNEL_14
#define LEFT_C_ADC_CH	ADC_CHANNEL_15
